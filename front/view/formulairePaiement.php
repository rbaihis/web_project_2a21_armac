        ...
        <form action="../controller/process3.php" method="post">
          <div class="products">
            ...
            $discount = 0;
              ...
              $result1 = $con->query("SELECT datacoupon.priceDiscount from dataoffre inner join datacoupon where dataCoupon.codeCoupon LIKE '$couponValue' AND datacoupon.id like dataoffre.idCoupon AND dataOffre.itemName like '$rowc[itemName]'	;") ;  
              ?>
                <div class="item">
                  ...
                  <?php
                    if (($result1->rowCount())==0){?>                 
                      ...
                      <?php }else{ while ($rowR1= $result1->fetch(PDO::FETCH_ASSOC)): 
                        ?>
