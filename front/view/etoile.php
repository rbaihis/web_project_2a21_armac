    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
	        		<input required type="text" name="user_name" id="user_name" class="form-control" placeholder="Enter Your Name" />
	        	</div>
	        	<div class="form-group">
	        		<textarea required name="user_review" id="user_review" class="form-control" placeholder="Type Review Here"></textarea>
	        	</div>
				<?php $result =$con->query("SELECT * FROM type_reclamation") ; ?>
				<select required name="type_id" id="type_id" class="form-select form-select-md mb-3">
