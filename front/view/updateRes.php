...
$res_C=new reservation();

$response = $res_C->getResById($_POST['idR'], $res_C->conn);

while ($resU = $response->fetch()) {
    $reservation=new reservation($resU['date'],$resU['idR']);
    $reservation->setId($resU['idR']);
}
