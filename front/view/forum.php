<?php
include 'C:\xampp\htdocs\t\front\Controller\questionC.php';
            ...
            <?php
                ...
                <div class="card mb-2">
                    <div class="card-body p-2 p-sm-3">
                        <div class="media forum-item">
                            <a href="#" data-toggle="collapse" data-target=".forum-content"><img src="https://bootdey.com/img/Content/avatar/avatar4.png" class="mr-3 rounded-circle" width="70" alt="User" /></a>
                            <div class="media-body">
                                <h6><a href="#" data-toggle="collapse" data-target=".forum-content" class="text-body">user:<?php echo $questionC['id_utilisateur']; ?></a></h6>
                                <p class="text-secondary">
                                <?php echo $questionC['texte']; ?>                                </p>
                                <p class="text-muted"><a href="javascript:void(0)">question<?php echo $questionC['id_question']; ?></a> replied <span class="text-secondary font-weight-bold"><?php echo $questionC['date']; ?></span></p>
                            </div>
                ...
                <ul class="pagination pagination-sm pagination-circle justify-content-center mb-0">
                    <li class="page-item disabled">
                        <span class="page-link has-icon"><i class="material-icons">first</i></span>
                    </li>
                    <li class="page-item"><a class="page-link" href="javascript:void(0)">1</a></li>
                    <li class="page-item active"><span class="page-link">2</span></li>
                    <li class="page-item"><a class="page-link" href="javascript:void(0)">3</a></li>
                    <li class="page-item">
                        <a class="page-link has-icon" href="javascript:void(0)"><i class="material-icons">last</i></a>
                    </li>
                </ul>
            </div>
            <!-- /Forum List -->
