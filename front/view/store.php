			...
			<section id="sidebar">
				<div class="py-3">
					...
					<?php foreach ($listeCategorie as $categorieC) :
						 ?>
							<option></option>
							<li  type="checkbox"  class="list-group-item list-group-item-action d-flex justify-content-between align-items-center category cat-checkbox "> <?php echo $categorieC['nomCategorie']; ?>
