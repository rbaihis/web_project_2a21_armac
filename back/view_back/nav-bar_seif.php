...
<html lang="en">
    ...
    <link rel="stylesheet" href="../../back/assets_back/css/fontawesomeseifseif.min.css">
    <!-- https://fontawesome.com/ -->
    <link rel="stylesheet" href="../../back/assets_back/css/fullcalendar.min.css">
    <!-- https://fullcalendar.io/ -->
    <link rel="stylesheet" href="../../back/assets_back/css/bootstrapseifseif.min.css">
    <!-- https://getbootstrap.com/ -->
    <link rel="stylesheet" href="../../back/assets_back/css/tooplateseif.css">
    ...
    <div class="col-12">
        <nav class="navbar navbar-expand-xl navbar-light bg-light">
            ...
            <ul class="navbar-nav mx-auto">
                            <!-- <li class="nav-item">
                                <a class="nav-link " href="../../back/view_back/index.php">Dashboard
