...
$id=$_GET['id'];
    ...
    $listeq = $questionC->recupererquestion($id);
    $date=$listeq['date'];
        ...
        <div class="row tm-mt-big">
            <div class="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                <div class="bg-white tm-block">
                    <div class="row">
                        <div class="col-12">
                            <h2 class="tm-block-title d-inline-block">modifier Question</h2>
                        </div>
                    </div>
...
<div id="error">
            ...
            <?php
            if (isset($_GET['id'])){
                $question = $questionC->recupererquestion($_GET['id']);
           ...
           <hr>    	
                ...
                <tr>
                    <td>
                        <label for="texte">Contenu de la question:
                        </label>
                    </td>
                    <td><input type="text" name="texte" id="texte" value="<?php echo $question['texte']; ?>" maxlength="20"></td>
                </tr>
       ...
       ?>
                        ...
                        <button class="btn"><a href="afficherquestion.php">Retour à la liste des questions</a></button>
</div>
                    </div>
                </div>
            </div>
