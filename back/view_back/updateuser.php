...
<?php 
    ...
    {  ?>
        ...
        <tr class="tm-list-group-item" id="<?= "l".$i ?>" > <td >
            <?php echo( htmlentities( $row['name'] ) );   ?>  
        </td><td id="<?= "l".$i."r".$j?>" >
            <?php echo( htmlentities( $row['address'] ) );  ?>
        </td><td id="<?= "l".$i."r".$j?>">
            <?php echo( htmlentities( $row['postalcode'] ) );  ?>
        </td><td id="<?= "l".$i."r".$j?>">
    ...
    <!-- passing user_id value as a get request to the destinated page to know the user we want to handle directly by his primary key -->
            <?php   echo( '<a href="updateuser.php?user_id='.$row['user_id'].'&name='.$row['name'].'&address='.$row['address'].'&postalcode='.$row['postalcode'].'&email='.$row['email'].' ">Update</a> / ');   ?>
            <?php echo( '<a  href="delete.php?user_id='.$row['user_id'].' ">Delete</a> ');    ?>
